class DrawingBoard {
    ...
    assignElement() {
        ...
        this.brushSizePreviewEl = this.brushPannelEl.querySelector("#brushSizePreview");
    ...
    addEvent() {
        ...
        this.downloadLinkEl.addEventListener("click", this.onClickDownloadLink.bind(this));
    }
    onClickDownloadLink() {
